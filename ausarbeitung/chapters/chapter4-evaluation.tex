...
\chapter{Evaluation and optimization}
	...
	We set the different algorithms in perspective in \autoref{fig:timeEvaluation-bars}. In \autoref{fig:timeEvaluation-pie} we show how the total runtime of 1095.84ms is built from the different parts of our final application.
