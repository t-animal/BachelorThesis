	...
	\begin{figure}
		...
		\begin{subfigure}{\textwidth}
			\begin{tikzpicture}
				...
				\end{semilogyaxis}
			\end{tikzpicture}
			\label{fig:fastCorrectness}
			\caption{Showing the data from FAST detector. This shows only a representative subset of 605 combinations of a total tested of 1440}
		\end{subfigure}
