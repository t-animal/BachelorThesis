...
\include{chapters/chapter1-einleitung}   % Einfuehrung (\chapter{Einf"uhrung})
\include{chapters/chapter2-detector}   % Einfuehrung (\chapter{Einf"uhrung})
\include{chapters/chapters-rest}   % Einfuehrung (\chapter{Einf"uhrung})
\cleardoublepage
