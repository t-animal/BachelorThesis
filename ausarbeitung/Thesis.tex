...
\HRule \\[0.4cm]
{ \huge \bfseries Implementation of an Android app for the recording of Go games by tracking their state}\\[0.15cm]
...
\includegraphics[width=0.6\textwidth]{./images/logo-techfak-blau.png}
